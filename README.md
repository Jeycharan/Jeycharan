...
| Project | Description |
|---|---|
| 🌐 **Disaster Relief Coordination Platform** | AI-powered MERN app using OpenAI embeddings for semantic matching of relief resources and requests |
| 🏥 **LiveMed** | Hospital management system — OPD queue management, bed availability, inventory, 4-role RBAC *(Patent No. 202542247892)* |
| 📚 **PrepEd** | Education platform with structured learning tools *(Patent No. 202541112595)* |
| 💰 **Spendwise** | Personal finance / expense tracking application |
| 🔗 **Shortify** | URL shortener built with JavaScript |
| 🏦 **Banking Application (Console)** | Console-based banking system in Java |
...
<p align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=Jeycharan&show_icons=true&theme=tokyonight&count_private=true" alt="Jey's GitHub Stats" height="165"/>
...
<p align="center"><i>⭐️ Open to Full-Stack / Backend SDE opportunities — let's build something impactful.</i></p>

<!--
**Jeycharan/Jeycharan** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
